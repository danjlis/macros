...
namespace Enable
{
  ...
  int HCALOUT_START_SECTOR = 0;
  int HCALOUT_N_SECTORS = 1;
}  // namespace Enable
                 ...
                 const int crossings)
{
  ...
  int startingSector = Enable::HCALOUT_START_SECTOR;
  int numSectors = Enable::HCALOUT_N_SECTORS;
  ...
  //hcal->set_double_param("tilt_angle", 0);
  ...
  hcal->set_int_param("n_sectors",numSectors);
  hcal->set_int_param("n_startingsector", startingSector);
